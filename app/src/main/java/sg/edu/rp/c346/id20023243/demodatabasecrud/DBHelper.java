...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public long insertNote(String noteContent) {
        ...
        db.close();
        Log.d("SQL Insert","ID:"+ result); //id returned must not be -1; if -1 means fail
        return result;
        //return how many inserted; long returns how many items inserted
    }
    ...
    public int updateNote(Note data) {
        ...
        //getNoteContent() is get method in Note class
        String condition = COLUMN_ID + "= ?"; //set condition
        String[] args = {String.valueOf(data.getId())}; //to get specific id for the condition
        int result = db.update(TABLE_NOTE, values, condition, args);
        //args will replace ? in line 88 by executing line 89
        db.close();
